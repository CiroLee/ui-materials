...
export const rows: ApiTableRow[] = [
  ...
  {
    prop: 'onChange',
    desc: 'change event of InputNumber',
  ...
  {
    prop: 'onInput',
    desc: 'input event of InputNumber',
    type: '(value: number | null) => void;',
    required: 'false',
    default: '-',
  },
  {
    prop: 'onBlur',
    desc: 'blur event of InputNumber',
  ...
  {
    prop: 'onFocus',
    desc: 'focus event of InputNumber',
    type: '(e: React.FocusEventHandler<HTMLInputElement>) => void',
    required: 'false',
    default: '-',
  },
  {
    prop: 'onStep',
    desc: 'step event of InputNumber',
