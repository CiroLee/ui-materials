...
import prefixSuffixContent from './docs/prefix-suffix.md?raw';
import decimalContent from './docs/decimal.md?raw';
import isInViewContent from './docs/isInView.md?raw';
