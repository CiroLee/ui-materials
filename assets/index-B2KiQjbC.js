import{j as s,l}from"./index-CWAQSh1m.js";import{L as t,B as i,H as n,C as e}from"./index-CFZkpu2j.js";import{C as r}from"./index-DRr8kPQN.js";const p=`<pre class="hljs"><code><span class="hljs-comment"># install necessary dependencies</span>
...
`,a="size-8 border border-gray-300 rounded-full flex-shrink-0 flex flex-center text-gray-700 mr-2",h=()=>s.jsxs("div",{className:"",children:[s.jsx("div",{className:"flex justify-end",children:s.jsx(t,{href:"https://github.com/CiroLee/ui-materials",isBlank:!0,children:s.jsxs(i,{size:"small",outline:!0,type:"text",className:"cursor-pointer",children:[s.jsx(l,{size:16,className:"mr-1"}),s.jsx("span",{children:"Github"})]})})}),s.jsx(n,{as:"h4",className:"my-12",children:"modern ui materials about react aiming to use easily"}),s.jsxs("div",{className:"flex items-center",children:[s.jsx(n,{as:"h5",className:a,children:"1"}),s.jsx("span",{children:"install basic dependencies"})]}),s.jsx(e,{className:"md:w-[80%] mb-8",content:p}),s.jsxs("div",{className:"flex items-center",children:[s.jsx(n,{as:"h5",className:a,children:"2"}),s.jsxs("span",{children:["copy plugins to your project, and import them in your ",s.jsx(r,{size:"tiny",children:"tailwind.plugin.js"})]})]}),s.jsx(e,{content:c,className:"md:w-[80%] mb-8"}),s.jsxs("div",{className:"flex items-center",children:[s.jsx(n,{as:"h5",className:a,children:"3"}),s.jsx("span",{children:"copy component codes to your project, just it!"})]}),s.jsx("p",{className:"text-gray-400 indent-10",children:"note: you may install some extra dependencies for some component, view code for detail"})]});export{h as default};
