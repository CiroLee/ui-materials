import{d as i,r as j,j as s}from"./index-COZO8Rzb.js";import{N as m,S as g,A as y}from"./index-CJvfj1Kn.js";import{C as l,H as p}from"./index-CaQzaSfZ.js";import{D as b}from"./index-BVOm_AMB.js";const u={command:"⌘",shift:"⇧",ctrl:"⌃",option:"⌥",enter:"⏎",delete:"⌦",escape:"⎋",tab:"⇥",capslock:"⇪",up:"↑",right:"→",down:"↓",left:"←",pageup:"⇞",pagedown:"⇟",home:"⇱",end:"⇲",help:"?",space:"␣"},f=i({base:`inline-flex flex-center relative px-[6px] border border-gray-200 shadow-[0_1px_1px_rgba(0,0,0,0.2)] shadow-inset-[0_1px_1px_rgba(255,255,255,0.7)]
   bg-gray-200/50 h-[24px] text-[14px] rounded-[4px] [&>span:not(:first-child)]:ml-1`}),t=j.forwardRef(function(e,c){const{keys:r,children:n,className:h,style:o}=e;return s.jsxs("div",{ref:c,className:f({class:h}),style:o,children:[r.map((d,x)=>s.jsx("span",{children:u[d]||""},x)),n?s.jsx("span",{children:n}):null]})});t.displayName="Kbd";const a=t,k=`<pre class="hljs"><code><span class="hljs-keyword">import</span> <span class="hljs-title class_">Kbd</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;your path/Kbd&#x27;</span>;
...
`,w=[{prop:"keys",desc:"keyboard keys",type:"KbdKey",required:!0,default:"-"},{prop:"className",type:"string",required:!1,default:"-"},{prop:"style",type:"React.CSSProperties",required:!1,default:"-"}];function D(){return s.jsxs(s.Fragment,{children:[s.jsx(m,{title:"Kbd",sourceName:"Kbd"}),s.jsx(b,{children:"A component to display keyboard input or hotkeys"}),s.jsxs(g,{className:"mb-4 [&>div]:mr-2",children:[s.jsx(a,{keys:["command"]}),s.jsx(a,{keys:["command"],children:"K"}),s.jsx(a,{keys:["command","shift"],children:"T"}),s.jsx(a,{keys:["option","command"],children:"D"})]}),s.jsx(l,{content:k}),s.jsx(p,{as:"h4",className:"my-4",children:"KbdKey"}),s.jsx(l,{content:K}),s.jsx(p,{as:"h4",className:"my-4",children:"API"}),s.jsx(y,{rows:w})]})}export{D as default};
