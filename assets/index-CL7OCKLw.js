...
`;function q(){const c=[{value:"apple",label:s.jsxs("div",{children:[s.jsx("p",{children:"apple"}),s.jsx("p",{children:"🍎"})]})},{value:"banana",label:s.jsxs("div",{children:[s.jsx("p",{children:"banana"}),s.jsx("p",{children:"🍌"})]})},{value:"orange",label:s.jsxs("div",{children:[s.jsx("p",{children:"orange"}),s.jsx("p",{children:"🍊"})]}),disabled:!0}];return s.jsxs(s.Fragment,{children:[s.jsx(o,{title:"Checkbox",sourceName:"Checkbox"}),s.jsxs(p,{className:"mb-4",children:[s.jsx(a,{as:"h4",className:"mb-2",children:"basic"}),s.jsx(l,{checked:!0,value:"apple",onCheckedChange:(n,h)=>console.log(n,h),children:"apple"}),s.jsx(e,{content:i})]}),s.jsxs(p,{className:"mb-4",children:[s.jsx(a,{as:"h4",className:"mb-2",children:"disabled"}),s.jsxs("div",{className:"flex items-center [&>*]:mr-2",children:[s.jsx(l,{disabled:!0,children:"disabled"}),s.jsx(l,{checked:!0,disabled:!0,children:"disabled"})]}),s.jsx(e,{content:g})]}),s.jsxs(p,{children:[s.jsx(a,{as:"h4",className:"mb-2",children:"checkbox group"}),s.jsx(r,{value:"orange",className:"flex [&>label]:mr-2 [&>label_button]:self-baseline [&_button]:mt-[6px]",options:c,onCheckedChange:n=>console.log("what you choose:",n)}),s.jsx(e,{content:u})]}),s.jsx(a,{as:"h2",className:"mb-2",children:"API"}),s.jsx(a,{as:"h4",className:"mb-2",children:"Checkbox"}),s.jsx(t,{rows:j}),s.jsx(a,{as:"h4",className:"my-2",children:"CheckboxGroup"}),s.jsx(t,{rows:d})]})}export{q as default};
