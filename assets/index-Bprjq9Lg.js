import{d as V,r as n,j as s,k as O}from"./index-COZO8Rzb.js";import{N as J,S as t,A as K}from"./index-CJvfj1Kn.js";import{B as a,H as l,C as p,a as d}from"./index-CaQzaSfZ.js";import{R as Q}from"./index-LpaIBCvh.js";import{a as U}from"./CheckboxGroup-wwGILpH-.js";import{P as W}from"./index-C0x8hFx6.js";import{D as X}from"./index-BVOm_AMB.js";import"./index-CCJ1iuAm.js";import"./index-BdZm8eSK.js";import"./index-BBEZAuME.js";import"./index-CR97gBd8.js";import"./index-C54nQ4GU.js";import"./index-CW1AifqN.js";import"./index-G4FVeZ_f.js";import"./index-BaEBlOYj.js";import"./index-ByhUHD7A.js";const $=V({slots:{base:"modal bg-white rounded-large py-4 shadow-[color:rgba(0,0,0,0.04)] shadow-[0_10px_15px_-4px,0_-10px_15px_-4px,10px_0_15px_-4px,-10px_0_15px_-4px] relative overflow-hidden",title:"px-4 font-bold overflow-hidden pr-6 ellipsis",commonClose:"absolute top-4 right-4",defaultCloseIcon:`size-[24px] rounded-small flex flex-center after:absolute after:rotate-45 after:w-[1px] after:h-[16px] after:rounded-[1px] after:bg-gray-400 before:absolute 
    before:-rotate-45 before:w-[1px] before:h-[16px] before:rounded-[1px] before:bg-gray-400 transition-colors hover:bg-gray-300/40 hover:after:bg-gray-600 hover:before:bg-gray-600`,content:"modal__content px-4 my-4 max-h-[65vh] overflow-auto last:mb-0",footer:"px-4 flex gap-3"},variants:{size:{small:{base:"w-[60vw] md:w-[32vw]"},medium:{base:"w-[70vw] md:w-[50vw]"},large:{base:"w-[94vw] md:w-[80vw]"}},footerAlign:{start:{footer:"justify-start"},end:{footer:"justify-end"},center:{footer:"justify-center"}}},defaultVariants:{size:"medium",footerAlign:"end"}});function Y({title:m}){const{title:o}=$();return s.jsx("div",{className:o(),children:m})}const H=n.forwardRef((m,o)=>{const{show:M,size:u,title:h,closeIcon:j,enableEsc:S=!0,maskClosable:C=!0,backdrop:x="translucent",footerAlign:q,footer:w,cancelText:_="取消",confirmText:B="确定",children:v,onClose:c,onConfirm:i,className:G,style:g}=m,{base:z,commonClose:r,defaultCloseIcon:A,content:f,footer:I}=$(),y=()=>{c(),i==null||i()},T=n.useMemo(()=>x==="transparent"?"[&_.popup-mask]:bg-transparent":"",[x]),k=R=>{R.key==="Escape"&&S&&c()};return n.useEffect(()=>(document.addEventListener("keydown",k),()=>{document.removeEventListener("keydown",k)}),[S]),s.jsx(W,{placement:"center",className:T,isBlur:x==="blur",show:M,ref:o,maskClosable:C,onClose:c,children:s.jsxs("div",{className:z({size:u,class:G}),style:g,children:[j===void 0?s.jsx("div",{className:r({class:A()}),onClick:c}):j===null?null:s.jsx("div",{className:r(),onClick:c,children:j}),n.isValidElement(h)?s.jsx(s.Fragment,{children:h}):h?s.jsx(Y,{title:h}):null,s.jsx("div",{className:f(),children:v}),w===void 0?s.jsxs("div",{className:I({footerAlign:q}),children:[s.jsx(a,{type:"text",outline:!0,onClick:c,children:_}),s.jsx(a,{onClick:y,children:B})]}):w===null?null:s.jsx(s.Fragment,{children:w})]})})});H.displayName="Modal";const e=H,Z=`<pre class="hljs"><code><span class="hljs-keyword">import</span> { useState } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;react&#x27;</span>;
