...
`,B=`<pre class="hljs"><code><span class="hljs-keyword">import</span> <span class="hljs-title class_">Segment</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;your path/Segment&#x27;</span>;
...
`,W=[{prop:"defaultValue",type:"string",desc:"default value of segment for initial",required:!1,default:"-"},{prop:"options",desc:"options of segment",type:"link: CommonOption(https://github.com/CiroLee/ui-materials/blob/main/src/packages/types/components.ts)",required:!0,default:"-"},{prop:"size",desc:"size of segment",type:"tag: tiny | small | medium | large",required:!1,default:"medium"},{prop:"colors",desc:"color theme of segment",type:"tag: default | primary | info | success | warn | danger",required:!1,default:"default"},{prop:"className",type:"string",required:!1,default:"-"},{prop:"style",type:"React.CssProperties",required:!1,default:"-"},{prop:"onSegmentChange",desc:"callback when segment item changed",required:!1,type:"(value: string) => void",default:"-"}],n=[{label:"apple",value:"apple"},{label:"banana",value:"banana"},{label:"orange",value:"orange"},{label:"beef",value:"beef",disabled:!0}],G=[{label:s.jsxs(s.Fragment,{children:[s.jsx(L,{size:18}),s.jsx("span",{children:"Photo"})]}),value:"photo"},{label:s.jsxs(s.Fragment,{children:[s.jsx(D,{size:18}),s.jsx("span",{children:"File"})]}),value:"file"},{label:s.jsxs(s.Fragment,{children:[s.jsx(F,{size:18}),s.jsx("span",{children:"Video"})]}),value:"video"}];function U(){return s.jsxs(s.Fragment,{children:[s.jsx(O,{title:"Segment",sourceName:"Segment"}),s.jsx(I,{children:"A component allows to navigte between sections in a view"}),s.jsxs(c,{className:"mb-4",children:[s.jsx(e,{as:"h4",className:"mb-2",children:"basic"}),s.jsx(a,{options:n,defaultValue:"orange",onSegmentChange:o=>{console.log("segment, you choose: ",o)}}),s.jsx(i,{content:E})]}),s.jsxs(c,{className:"mb-4",children:[s.jsx(e,{as:"h4",className:"mb-2",children:"size"}),s.jsxs("div",{className:"flex items-center flex-wrap gap-3",children:[s.jsxs("div",{children:[s.jsx("p",{className:"text-sm mb-1 ml-1",children:"tiny:"}),s.jsx(a,{size:"tiny",options:n})]}),s.jsxs("div",{children:[s.jsx("p",{className:"text-sm mb-1 ml-1",children:"small:"}),s.jsx(a,{size:"small",options:n})]}),s.jsxs("div",{children:[s.jsx("p",{className:"text-sm mb-1 ml-1",children:"medium:"}),s.jsx(a,{size:"medium",options:n})]}),s.jsxs("div",{children:[s.jsx("p",{className:"text-sm mb-1 ml-1",children:"large:"}),s.jsx(a,{size:"large",options:n})]})]}),s.jsx(i,{content:H})]}),s.jsxs(c,{className:"mb-4",children:[s.jsx(e,{as:"h4",className:"mb-2",children:"layout evenly"}),s.jsx(a,{options:n,className:"[&_.segment-item]:w-[100px] mb-3 mr-3"}),s.jsx(a,{options:n,className:"w-[408px] [&_.segment-item]:flex-1"}),s.jsx(i,{content:T})]}),s.jsxs(c,{className:"mb-4",children:[s.jsx(e,{as:"h4",className:"mb-2",children:"with icon"}),s.jsx(a,{options:G,className:"[&_.segment-item]:w-[80px]"}),s.jsx(i,{content:X})]}),s.jsxs(c,{className:"mb-4",children:[s.jsx(e,{as:"h4",className:"mb-2",children:"colors"}),s.jsxs("div",{className:"flex flex-wrap gap-3",children:[s.jsx(a,{colors:"default",options:n}),s.jsx(a,{colors:"primary",options:n}),s.jsx(a,{colors:"info",options:n}),s.jsx(a,{colors:"success",options:n}),s.jsx(a,{colors:"warn",options:n}),s.jsx(a,{colors:"danger",options:n})]}),s.jsx(i,{content:B})]}),s.jsx(e,{as:"h2",className:"mb-4",children:"API"}),s.jsx($,{rows:W})]})}export{U as default};
