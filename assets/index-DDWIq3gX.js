import{d as w,r,j as s,W as v,C as k,G as C}from"./index-COZO8Rzb.js";import{N as R,S as e,A as q}from"./index-CJvfj1Kn.js";import{B as V,c as N,H as t,C as c}from"./index-CaQzaSfZ.js";import{$ as B,a as _}from"./index-CCJ1iuAm.js";import{D as G}from"./index-BVOm_AMB.js";import"./index-BdZm8eSK.js";import"./index-BBEZAuME.js";import"./index-CR97gBd8.js";import"./index-C54nQ4GU.js";import"./index-CW1AifqN.js";import"./index-G4FVeZ_f.js";import"./index-BaEBlOYj.js";import"./index-ByhUHD7A.js";const z=w({base:"flex gap-x-2.5"}),j=r.forwardRef((a,o)=>{const{value:u,type:i="outline",options:g,size:d,className:m,style:x,onValueChange:h}=a,[y,f]=r.useState(u||""),b=r.useMemo(()=>i==="outline"?"border-brand-500":"border-0 bg-brand-500 text-white hover:bg-brand-500/90 active:bg-brand-600",[i]);return s.jsx(B,{ref:o,className:z({class:m}),style:x,onValueChange:n=>{f(n),h==null||h(n)},children:g.map(n=>s.jsx(_,{asChild:!0,disabled:n.disabled,value:n.value,children:s.jsx(V,{outline:!0,type:"text",shape:"square",size:d,className:N({[b]:y===n.value}),children:n.label})},n.value))})});j.displayName="RadioButtonGroup";const l=j,O=`<pre class="hljs"><code><span class="hljs-keyword">import</span> <span class="hljs-title class_">RadioButtonGroup</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;your path/RadioButtonGroup&#x27;</span>;
