import{d as v,r,j as s,W as w,C as k,G as C}from"./index-CWAQSh1m.js";import{N as R,S as e,A as q}from"./index-debLFT2i.js";import{B as V,c as N,H as t,C as c}from"./index-CFZkpu2j.js";import{$ as B,a as _}from"./index-D4q477Rv.js";import"./index-BE7BTzfY.js";import"./index-Ymriocpz.js";import"./index-BWaxllYI.js";import"./index-D3Fp8qFQ.js";import"./index-DHLCuQWH.js";import"./index-B9_cC6Ym.js";import"./index-cnE9lUNP.js";const G=v({base:"flex gap-x-2.5"}),j=r.forwardRef((a,o)=>{const{value:u,type:i="outline",options:g,size:d,className:m,style:x,onValueChange:h}=a,[y,f]=r.useState(u||""),b=r.useMemo(()=>i==="outline"?"border-brand-500":"border-0 bg-brand-500 text-white hover:bg-brand-500/90 active:bg-brand-600",[i]);return s.jsx(B,{ref:o,className:G({class:m}),style:x,onValueChange:n=>{f(n),h==null||h(n)},children:g.map(n=>s.jsx(_,{asChild:!0,disabled:n.disabled,value:n.value,children:s.jsx(V,{outline:!0,type:"text",shape:"square",size:d,className:N({[b]:y===n.value}),children:n.label})},n.value))})});j.displayName="RadioButtonGroup";const l=j,z=`<pre class="hljs"><code><span class="hljs-keyword">import</span> <span class="hljs-title class_">RadioButtonGroup</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;your path/RadioButtonGroup&#x27;</span>;
