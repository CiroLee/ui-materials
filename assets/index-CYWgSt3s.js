import{d as w,r,j as s,W as v,C as k,G as C}from"./index-DNICQ8NF.js";import{N as R,D as q,S as e,A as V}from"./index-rJa6HX1d.js";import{B as N,c as B,H as t,C as c}from"./index-_DhQyXzb.js";import{$ as _,a as G}from"./index-C-cdsa15.js";import"./index-CA-e9VSr.js";import"./index-C4qS0b9r.js";import"./index-CSqJZj69.js";import"./index-D759T38V.js";import"./index-Cx4UYWJX.js";import"./index-CkxT94Wl.js";import"./index-CZ68qV6A.js";const z=w({base:"flex gap-x-2.5"}),j=r.forwardRef((a,o)=>{const{value:u,type:i="outline",options:g,size:d,className:m,style:x,onValueChange:h}=a,[y,f]=r.useState(u||""),b=r.useMemo(()=>i==="outline"?"border-brand-500":"border-0 bg-brand-500 text-white hover:bg-brand-500/90 active:bg-brand-600",[i]);return s.jsx(_,{ref:o,className:z({class:m}),style:x,onValueChange:n=>{f(n),h==null||h(n)},children:g.map(n=>s.jsx(G,{asChild:!0,disabled:n.disabled,value:n.value,children:s.jsx(N,{outline:!0,type:"text",shape:"square",size:d,className:B({[b]:y===n.value}),children:n.label})},n.value))})});j.displayName="RadioButtonGroup";const l=j,O=`<pre class="hljs"><code><span class="hljs-keyword">import</span> <span class="hljs-title class_">RadioButtonGroup</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;your path/RadioButtonGroup&#x27;</span>;
