import{d as v,r,j as s,W as w,C as k,G as C}from"./index-DVJh4_k1.js";import{N as q,S as e,A as R}from"./index-BJRHTw7p.js";import{B as V,c as N,H as t,C as c}from"./index-C2mXlWvz.js";import{$ as B,a as _}from"./index-sf1bR_d_.js";import"./index-CmCUS2YP.js";import"./index-BqrRrWwI.js";import"./index-DW2Cozmn.js";import"./index-DbxdkObA.js";import"./index-BKb5tYFp.js";import"./index-GVr0sQU_.js";import"./index-DJeFikaz.js";const G=v({base:"flex gap-x-2.5"}),j=r.forwardRef((a,o)=>{const{value:u,type:i="outline",options:g,size:d,className:m,style:x,onValueChange:h}=a,[y,f]=r.useState(u||""),b=r.useMemo(()=>i==="outline"?"border-brand-500":"border-0 bg-brand-500 text-white hover:bg-brand-500/90 active:bg-brand-600",[i]);return s.jsx(B,{ref:o,className:G({class:m}),style:x,onValueChange:n=>{f(n),h==null||h(n)},children:g.map(n=>s.jsx(_,{asChild:!0,disabled:n.disabled,value:n.value,children:s.jsx(V,{outline:!0,type:"text",shape:"square",size:d,className:N({[b]:y===n.value}),children:n.label})},n.value))})});j.displayName="RadioButtonGroup";const l=j,z=`<pre class="hljs"><code><span class="hljs-keyword">import</span> <span class="hljs-title class_">RadioButtonGroup</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;your path/RadioButtonGroup&#x27;</span>;
