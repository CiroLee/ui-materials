import{d as v,r,j as s,W as w,B as k,C}from"./index-C05EYDUz.js";import{B as R,c as q,N as V,S as e,C as c,A as N}from"./index-B5CGe3bm.js";import{H as t}from"./index-BJmJd5F7.js";import{$ as B,a as _}from"./index-XjonErWY.js";import"./index-C-r7zJs6.js";import"./index-CWVVL8aY.js";import"./index-C4LmOpUy.js";import"./index-Cu1IrRYP.js";import"./index-CcoCkn0N.js";import"./index-Dkd40zvW.js";import"./index-Bqa_tqQn.js";const G=v({base:"flex gap-x-2.5"}),j=r.forwardRef((a,o)=>{const{value:u,type:i="outline",options:g,size:d,className:m,style:x,onValueChange:h}=a,[y,f]=r.useState(u||""),b=r.useMemo(()=>i==="outline"?"border-brand-500":"border-0 bg-brand-500 text-white hover:bg-brand-500/90 active:bg-brand-600",[i]);return s.jsx(B,{ref:o,className:G({class:m}),style:x,onValueChange:n=>{f(n),h==null||h(n)},children:g.map(n=>s.jsx(_,{asChild:!0,disabled:n.disabled,value:n.value,children:s.jsx(R,{outline:!0,type:"text",shape:"square",size:d,className:q({[b]:y===n.value}),children:n.label})},n.value))})});j.displayName="RadioButtonGroup";const l=j,z=`<pre class="hljs"><code><span class="hljs-keyword">import</span> <span class="hljs-title class_">RadioButtonGroup</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;your path/RadioButtonGroup&#x27;</span>;
