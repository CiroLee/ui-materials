import{d as W,r as u,j as s,L as D,F as g,o as X}from"./index-DVJh4_k1.js";import{C as Y}from"./CheckboxGroup-BZGFeg6w.js";import{N as Z,S as o,A as ss}from"./index-BJRHTw7p.js";import{H as t,C as i}from"./index-C2mXlWvz.js";import{g as n}from"./input.style-BqcXTAcm.js";import"./index-CmCUS2YP.js";import"./index-BqrRrWwI.js";import"./index-DW2Cozmn.js";import"./index-GVr0sQU_.js";import"./index-DJeFikaz.js";const as=W({slots:{base:`${n.base} group`,input:n.input,prefix:n.prefix,rightBlock:"relative flex flex-col flex-center overflow-hidden",spinButton:`select-none relative bg-brand-500/10 flex flex-center opacity-0 transition-all duration-200 
    ease-linear group-hover:opacity-100 group/btn hover:bg-brand-500/20 rounded-[2px]`,spinArrow:"text-gray-400/60 group-hover/btn:text-brand-500"},variants:{size:{tiny:{base:n.tinyBase,input:`${n.smallInput} px-[6px]`,spinButton:"size-[10px]",spinArrow:"size-[10px]",rightBlock:"pr-[4px]"},small:{base:n.smallBase,input:`${n.smallInput} px-[6px]`,spinButton:"size-[10px]",spinArrow:"size-[10px]",rightBlock:"pr-[6px]"},medium:{base:n.mediumBase,input:`${n.mediumInput} px-[8px]`,spinButton:"size-[14px]",spinArrow:"size-[14px]",rightBlock:"pr-[8px]"},large:{base:n.largeBase,input:`${n.largeInput} px-[8px]`,spinButton:"size-[16px]",spinArrow:"size-[16px]",rightBlock:"pr-[8px]"}},disabled:{true:{base:n.disabledBase,input:n.disabledInput,rightBlock:"opacity-0"}},status:{error:{base:n.errorBase,prefix:"[&>*]:text-danger-500",suffix:"[&>*]:text-danger-500",spinButton:"bg-danger-500/10 hover:bg-danger-500/20"},warn:{base:n.warnBase,prefix:"[&>*]:text-warn-500",suffix:"[&>*]:text-warn-500",spinButton:"bg-warn-500/10 hover:bg-warn-500/20"},readonly:{}}},defaultVariants:{size:"medium"}}),$=u.forwardRef((x,N)=>{const{size:p,value:k,status:r,step:h=1,placeholder:L,min:j=-1/0,max:y=1/0,disabled:f,keyboard:z=!0,prefix:C,onChange:v,onInput:I,onBlur:q,onFocus:A,onStep:B,className:M,style:H}=x,{base:V,input:F,spinButton:S,spinArrow:_,rightBlock:T,prefix:E}=as(),K=u.useRef(null),[c,m]=u.useState(k??""),P=u.useMemo(()=>Number(c)>=y,[c]),U=u.useMemo(()=>Number(c)<=j,[c]),R=a=>a===""?null:Number(a),O=a=>{const e=a.currentTarget;m(e.value),I==null||I(R(e.value))},G=a=>{const e=a.currentTarget;v==null||v(R(e.value))},J=a=>{const e=a.currentTarget;if(e.value==="")return;const w=Number(e.value);w>y?m(y.toString()):w<j&&m(j.toString()),q==null||q(a)},b=(a,e,w=!1)=>{const d=c?e==="increase"?Number(c)+a:Number(c)-a:a;if(e==="increase"&&d<j)m(String(j));else{if(d<j||d>y||r==="readonly")return;m(String(d))}w&&(B==null||B(d,{step:a,type:e}))},Q=a=>{a.key!=="ArrowUp"&&a.key!=="ArrowDown"||(a.preventDefault(),[a.key==="ArrowUp",z].every(Boolean)&&b(h,"increase"),[a.key==="ArrowDown",z].every(Boolean)&&b(h,"decrease"))};return s.jsxs("label",{ref:N,className:V({size:p,status:r,disabled:f,class:M}),style:H,children:[C?s.jsx("div",{className:E({status:r}),children:C}):null,s.jsx("input",{ref:K,type:"number",value:c??"",disabled:f,placeholder:L,readOnly:r==="readonly",className:F({size:p,disabled:f,class:"input-number"}),onInput:O,onChange:G,onBlur:J,onFocus:A,onKeyDown:Q}),s.jsxs("div",{className:T({size:p,disabled:f}),children:[s.jsx("div",{className:S({status:r,size:p,class:`${P?"cursor-not-allowed":""}`}),onClick:()=>b(h,"increase",!0),children:s.jsx(D,{className:_()})}),s.jsx("div",{className:S({status:r,size:p,class:`${U?"cursor-not-allowed":""}`}),onClick:()=>b(h,"decrease",!0),children:s.jsx(D,{className:_({class:"rotate-180"})})})]})]})});$.displayName="InputNumber";const l=$,ns=`<pre class="hljs"><code><span class="hljs-keyword">import</span> { useState } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;react&#x27;</span>;
