import{u as i,r as j,j as s,s as m,S as u,i as g}from"./index-BjDtT8fq.js";import{N as d,S as e,A as c}from"./index-BMqOMO7u.js";import{H as a,B as n,C as l}from"./index-ELNk07RW.js";import{R as x}from"./index-beOz-6H6.js";import"./index-JDvxtZZs.js";import"./index-B7Kw24g9.js";import"./index-BI4bGl4_.js";import"./index-DnxZLGbc.js";import"./index-CksNcvaH.js";import"./index-BuSrsBkO.js";import"./index-qv5w81yh.js";import"./index-CkSz0Wqv.js";const y=`<pre class="hljs"><code><span class="hljs-comment">// first, place the ToastProvider component at the root of your app.</span>
...
`,C=[{prop:"duration",desc:"displayed duration of toast, unit is millisecond",type:"number",required:!1,default:"2000"},{prop:"placement",desc:"placement of toast",required:!1,type:"tag: topCenter | topLeft | topRight | bottomCenter | bottomLeft | bottomRight | center",default:"topCenter"},{prop:"icon",desc:"prefix icon of toast",required:!1,type:"React.ReactNode",default:"-"},{prop:"action",type:"React.ReactNode",desc:"suffix action of toast",required:!1,default:"-"},{prop:"autoClose",desc:"whether auto close toast after duration",type:"boolean",required:!1,default:"true"}],T=[{prop:"toast",desc:"toast function to show toast",type:"(text: string, options?: ToastOptions) => void",required:!1},{prop:"closeToast",desc:"close toast",type:"() => void",required:!1}],p="this is a toast message",v=[{label:"topLeft",value:"topLeft"},{label:"topCenter",value:"topCenter"},{label:"topRight",value:"topRight"},{label:"bottomLeft",value:"bottomLeft"},{label:"bottomCenter",value:"bottomCenter"},{label:"bottomRight",value:"bottomRight"},{label:"center",value:"center"}];function G(){const{toast:t,closeToast:r}=i(),[o,h]=j.useState("topCenter");return s.jsxs(s.Fragment,{children:[s.jsx(d,{title:"Toast",sourceName:"Toast"}),s.jsxs(e,{className:"mb-4",children:[s.jsx(a,{as:"h4",className:"mb-2",children:"basic"}),s.jsx(n,{onClick:()=>t(p),children:"Show Toast"}),s.jsx(l,{content:y}),s.jsx(l,{content:f})]}),s.jsxs(e,{className:"mb-4",children:[s.jsx(a,{as:"h4",className:"mb-2",children:"placement"}),s.jsx(x,{className:"w-[440px] grid grid-cols-3 gap-3 mb-3",value:o,options:v,onValueChange:h}),s.jsx(n,{onClick:()=>{t(p,{placement:o})},children:"show toast"}),s.jsx(l,{content:w})]}),s.jsxs(e,{className:"mb-4",children:[s.jsx(a,{as:"h4",className:"mb-2",children:"with icons"}),s.jsxs("div",{className:"flex gap-3",children:[s.jsx(n,{onClick:()=>{t(p,{icon:s.jsx(m,{size:18,className:"text-green-500"})})},children:"info"}),s.jsx(n,{onClick:()=>{t(p,{icon:s.jsx(u,{size:18,className:"text-blue-500"})})},children:"success"})]}),s.jsx(l,{content:k})]}),s.jsxs(e,{className:"mb-4",children:[s.jsx(a,{as:"h4",className:"mb-2",children:"action"}),s.jsx(n,{onClick:()=>{t(p,{autoClose:!1,icon:s.jsx(g,{size:18,className:"text-red-500"}),action:s.jsx(n,{size:"tiny",outline:!0,type:"text",onClick:r,children:"action"})})},children:"show toast"}),s.jsx(l,{content:b})]}),s.jsx(a,{as:"h2",className:"mb-2",children:"API"}),s.jsx(a,{as:"h4",className:"mb-2",children:"hooks"}),s.jsx(c,{rows:T}),s.jsx(a,{as:"h4",className:"my-2",children:"ToastOptions"}),s.jsx(c,{rows:C})]})}export{G as default};
