import{r as a,d as z,j as s,A as H,m as K}from"./index-DVJh4_k1.js";import{H as u,B as f,C as b}from"./index-C2mXlWvz.js";import{N as G,S as v,A as L}from"./index-BJRHTw7p.js";import{$ as U,a as C,b as Z,_ as g,c as J}from"./index-CmCUS2YP.js";import{a as Q,$ as P}from"./index-BqrRrWwI.js";import{$ as N,a as W,b as X,c as Y,d as ss,e as as,f as ns}from"./index-DTZof9Vw.js";import{h as ts,b as es,$ as ls,a as ps}from"./Combination-GWCymQDm.js";import{$ as os}from"./index-BKb5tYFp.js";import{$ as E}from"./index-DJeFikaz.js";import{S as cs}from"./index-Ckg4ax1j.js";import"./index-DW2Cozmn.js";import"./index-GVr0sQU_.js";const R="Popover",[S,Zs]=U(R,[N]),k=N(),[rs,$]=S(R),is=n=>{const{__scopePopover:r,children:l,open:p,defaultOpen:t,onOpenChange:e,modal:o=!1}=n,c=k(r),i=a.useRef(null),[h,j]=a.useState(!1),[x=!1,d]=Q({prop:p,defaultProp:t,onChange:e});return a.createElement(W,c,a.createElement(rs,{scope:r,contentId:os(),triggerRef:i,open:x,onOpenChange:d,onOpenToggle:a.useCallback(()=>d(w=>!w),[d]),hasCustomAnchor:h,onCustomAnchorAdd:a.useCallback(()=>j(!0),[]),onCustomAnchorRemove:a.useCallback(()=>j(!1),[]),modal:o},l))},hs="PopoverTrigger",ds=a.forwardRef((n,r)=>{const{__scopePopover:l,...p}=n,t=$(hs,l),e=k(l),o=C(r,t.triggerRef),c=a.createElement(Z.button,g({type:"button","aria-haspopup":"dialog","aria-expanded":t.open,"aria-controls":t.contentId,"data-state":D(t.open)},p,{ref:o,onClick:P(n.onClick,t.onOpenToggle)}));return t.hasCustomAnchor?c:a.createElement(X,g({asChild:!0},e),c)}),A="PopoverPortal",[js,gs]=S(A,{forceMount:void 0}),us=n=>{const{__scopePopover:r,forceMount:l,children:p,container:t}=n,e=$(A,r);return a.createElement(js,{scope:r,forceMount:l},a.createElement(E,{present:l||e.open},a.createElement(Y,{asChild:!0,container:t},p)))},y="PopoverContent",fs=a.forwardRef((n,r)=>{const l=gs(y,n.__scopePopover),{forceMount:p=l.forceMount,...t}=n,e=$(y,n.__scopePopover);return a.createElement(E,{present:p||e.open},e.modal?a.createElement(ms,g({},t,{ref:r})):a.createElement(xs,g({},t,{ref:r})))}),ms=a.forwardRef((n,r)=>{const l=$(y,n.__scopePopover),p=a.useRef(null),t=C(r,p),e=a.useRef(!1);return a.useEffect(()=>{const o=p.current;if(o)return ts(o)},[]),a.createElement(es,{as:J,allowPinchZoom:!0},a.createElement(B,g({},n,{ref:t,trapFocus:l.open,disableOutsidePointerEvents:!0,onCloseAutoFocus:P(n.onCloseAutoFocus,o=>{var c;o.preventDefault(),e.current||(c=l.triggerRef.current)===null||c===void 0||c.focus()}),onPointerDownOutside:P(n.onPointerDownOutside,o=>{const c=o.detail.originalEvent,i=c.button===0&&c.ctrlKey===!0,h=c.button===2||i;e.current=h},{checkForDefaultPrevented:!1}),onFocusOutside:P(n.onFocusOutside,o=>o.preventDefault(),{checkForDefaultPrevented:!1})})))}),xs=a.forwardRef((n,r)=>{const l=$(y,n.__scopePopover),p=a.useRef(!1),t=a.useRef(!1);return a.createElement(B,g({},n,{ref:r,trapFocus:!1,disableOutsidePointerEvents:!1,onCloseAutoFocus:e=>{var o;if((o=n.onCloseAutoFocus)===null||o===void 0||o.call(n,e),!e.defaultPrevented){var c;p.current||(c=l.triggerRef.current)===null||c===void 0||c.focus(),e.preventDefault()}p.current=!1,t.current=!1},onInteractOutside:e=>{var o,c;(o=n.onInteractOutside)===null||o===void 0||o.call(n,e),e.defaultPrevented||(p.current=!0,e.detail.originalEvent.type==="pointerdown"&&(t.current=!0));const i=e.target;((c=l.triggerRef.current)===null||c===void 0?void 0:c.contains(i))&&e.preventDefault(),e.detail.originalEvent.type==="focusin"&&t.current&&e.preventDefault()}}))}),B=a.forwardRef((n,r)=>{const{__scopePopover:l,trapFocus:p,onOpenAutoFocus:t,onCloseAutoFocus:e,disableOutsidePointerEvents:o,onEscapeKeyDown:c,onPointerDownOutside:i,onFocusOutside:h,onInteractOutside:j,...x}=n,d=$(y,l),w=k(l);return ls(),a.createElement(ps,{asChild:!0,loop:!0,trapped:p,onMountAutoFocus:t,onUnmountAutoFocus:e},a.createElement(ss,{asChild:!0,disableOutsidePointerEvents:o,onInteractOutside:j,onEscapeKeyDown:c,onPointerDownOutside:i,onFocusOutside:h,onDismiss:()=>d.onOpenChange(!1)},a.createElement(as,g({"data-state":D(d.open),role:"dialog",id:d.contentId},w,x,{ref:r,style:{...x.style,"--radix-popover-content-transform-origin":"var(--radix-popper-transform-origin)","--radix-popover-content-available-width":"var(--radix-popper-available-width)","--radix-popover-content-available-height":"var(--radix-popper-available-height)","--radix-popover-trigger-width":"var(--radix-popper-anchor-width)","--radix-popover-trigger-height":"var(--radix-popper-anchor-height)"}}))))}),bs=a.forwardRef((n,r)=>{const{__scopePopover:l,...p}=n,t=k(l);return a.createElement(ns,g({},t,p,{ref:r}))});function D(n){return n?"open":"closed"}const vs=is,$s=ds,ws=us,ys=fs,Ps=bs,ks={"top-start":{base:"origin-bottom-left"},"top-center":{base:"origin-bottom"},"top-end":{base:"origin-bottom-right"},"right-start":{base:"origin-top-left"},"right-center":{base:"origin-left"},"right-end":{base:"origin-bottom-left"},"bottom-start":{base:"origin-top-left"},"bottom-center":{base:"origin-top"},"bottom-end":{base:"origin-top-right"},"left-start":{base:"origin-top-right"},"left-center":{base:"origin-right"},"left-end":{base:"origin-top-right"}},_s=z({slots:{base:"p-3 rounded-large bg-white drop-shadow-around",title:"font-bold",content:"text-sm text-zinc-400"},variants:{placement:ks},defaultVariants:{placement:"bottom-center"}}),qs={open:{opacity:1,scale:1},closed:{opacity:0,scale:.8}},F=a.forwardRef((n,r)=>{const{isOpen:l,disabled:p,title:t,content:e,sideOffset:o=5,showArrow:c=!0,align:i="center",side:h="bottom",onOpenChange:j,children:x,className:d,style:w}=n,[q,_]=a.useState(!1),{base:I,title:M,content:T}=_s(),V=O=>{p||(_(O),j==null||j(O))};return a.useEffect(()=>{p&&_(!1),_(!!l)},[l,p]),s.jsxs(vs,{onOpenChange:V,children:[s.jsx($s,{asChild:!0,children:x}),s.jsx(H,{children:q?s.jsx(ws,{forceMount:!0,children:s.jsx(ys,{className:"outline-0",ref:r,sideOffset:o,align:i,side:h,children:s.jsxs(K.div,{className:I({placement:`${h}-${i}`,class:d}),style:w,initial:"closed",animate:q?"open":"closed",exit:"closed",variants:qs,children:[a.isValidElement(t)?t:t?s.jsx("div",{className:M(),children:t}):null,a.isValidElement(e)?e:e?s.jsx("div",{className:T(),children:e}):null,c?s.jsx(Ps,{className:"fill-white"}):null]})})}):null})]})});F.displayName="Popover";const m=F,Os=`<pre class="hljs"><code><span class="hljs-keyword">import</span> { useState } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;react&#x27;</span>
